...
class RecyclerViewAdapter2(private val mContext: Context?, ImageResourceId: ArrayList<String>, location: ArrayList<String>, Desc: ArrayList<String>, id1:ArrayList<String>) : RecyclerView.Adapter<RecyclerViewAdapter2.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            imageView = itemView.findViewById<View>(R.id.recyclerViewItem_imageView2) as ImageView
            locationView = itemView.findViewById<View>(R.id.recyclerView_title2) as TextView
            descView = itemView.findViewById<View>(R.id.recyclerView_desc2) as TextView
            constraintLayout= itemView.findViewById<View>(R.id.constraint2) as ConstraintLayout
        }
    }
